    ...
    <div className="main-reading">
      ...
      <section className="reading">
        <Link className="reading-link" to="#">
          ...
          <p className="reading__info1">
            Bonna abakkiriza, baabanga wamu, n'ebyabwe byonna nga babissa wamu.
          </p>
          <h4 className="reading__subtitle2">Bye tusoma mu kitabo ky'Ebikolwa by'Abatume [2:42-47]</h4>
      ...
      <section className="reading">
        <Link className="reading-link" to="#">
          <h2>OLUYIMBA OLW’OKWEBUULIRIRA: Zabbuli 117: 2-4, 13-15, 22-24</h2>
          ...
          <p className="reading__info2">
            ...
            <p className="reading__info2">
            Ejjinja lye
            baasuulagana nga bazimba, lye lyafuuka lukulwe mu nsonda. *Luno lwe
            lunaku Omukama lw'akoze, tulujaganyizeemu, tulusanyukiremu. Ekidd.
          </p>
        </Link>
      </section>
      <section className="reading">
        <Link className="reading-link" to="#">
          ...
          <h4>Bye tusoma mu Bbaluwa embereberye eya Petro Omutume [1:3-9]</h4>
      ...
      <section className="reading">
        <Link className="reading-link" to="#">
          <h2>EVANJIRI</h2>
          <p>Bwe waayita ennaku munaana Yezu n’ajja.</p>
          <h4>
            ...
            <p className="reading__info2">Toma omu ku Kkumi n'ababiri ayitibwa Omulongo
            (Didimo) tiyali na banne Yezu Iwe yajja. Abayigirizwa banne ne
            bamugamba nti: Omukama tumulabye! Ye n'abaddamu nti: Wabula nga
            ndabye mu bibatu bye, ebiwundu eby'enninga ne mbissaamu olunwe
            lwange, ne nzisa n'omukono mu lubiriizi; sijja kukkiriza. 
            </p>
            <p className="reading__info2">Ne wayita
            ennaku munaana; era abayigirizwa be baali mu nju, ne Toma, nga
            mw'ali nabo. Yezu n'ajja, enzigi nga nzigale, n'abayimiriramu wakati
            n'abagamba nti: Emirembe gibe ku mmwe! Awo n'agamba Toma nti: Olunwe
            Iwo luyingize wano, laba n'ebibatu byange; leeta n'omukono gwo
            oguteeke mu lubiriizi lwange; leka butakkiriza, naye kkiriza. Toma
            n'addamu n'amugamba nti: Mukama wange, Katonda wange! Yezu
            ...
            <p className="reading__info2">
            Bino  byawandiikibwa mulyoke mukkirizeYezu nga ye Kristu Omwana wa Katonda, ate olw'okukkiriza mutyo, mufune obulamu mu linnya lye. 
          </p>
          <h4>Ebyo Omukama y’abyogera. Katonda yeebale</h4>
        </Link>
      </section>
