...
.RS 0
.IP \(bu 2
\fBexpires\fP: null or a simplified extended <a to="https://en\.wikipedia\.org/wiki/ISO_8601" target="_blank">ISO 8601 format</a>: \fBYYYY\-MM\-DDTHH:mm:ss\.sssZ\fP
.IP \(bu 2
...
.RE
.P
See this <a to="https://registry\.npmjs\.org/\-/npm/v1/keys" target="_blank">example key's response from the public npm registry</a>\|\.
.SS Audit Endpoints
.P
