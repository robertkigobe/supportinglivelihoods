...
```js
parser.attribute({attribute: 'to'}).type;
// => 'attribute'
```
...
selector string `h1 h2 h3, [to] > p`, is represented as two selector nodes.
...
Example: `[ /*before*/ to /* after-attr */ = /* after-operator */ te/*inside-value*/st/* wow */ /*omg*/i/*bbq*/ /*whodoesthis*/]` would parse as:
