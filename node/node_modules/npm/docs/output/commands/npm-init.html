...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><ul><li><a to="#forwarding-additional-options">Forwarding additional options</a></li></ul><li><a to="#examples">Examples</a></li><li><a to="#workspaces-support">Workspaces support</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#yes"><code>yes</code></a></li><li><a to="#force"><code>force</code></a></li><li><a to="#scope"><code>scope</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#workspaces-update"><code>workspaces-update</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
which will be installed by <a to="../commands/npm-exec.html"><code>npm-exec</code></a>, and then have its
...
<a to="https://npm.im/create-react-app"><code>create-react-app</code></a>:</p>
<pre lang="bash"><code>$ npm init react-app ./my-react-app
</code></pre>
<p>Create a new <code>esm</code>-compatible package using
<a to="https://npm.im/create-esm"><code>create-esm</code></a>:</p>
...
<a to="https://npm.im/create-react-app"><code>create-react-app</code></a>, the following syntax
...
<li><a to="http://npm.im/init-package-json">init-package-json module</a></li>
...
<li><a to="../commands/npm-exec.html">npm exec</a></li>
<li><a to="../using-npm/workspaces.html">npm workspaces</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-init.md">
