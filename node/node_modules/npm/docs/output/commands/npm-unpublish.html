...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#warning">Warning</a></li><li><a to="#description">Description</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#force"><code>force</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<p>Consider using the <a to="../commands/npm-deprecate.html"><code>deprecate</code></a> command instead,
...
<p>The npm registry will return an error if you are not <a to="../commands/npm-adduser.html">logged
in</a>.</p>
...
<li><a to="../commands/npm-adduser.html">npm login</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-unpublish.md">
