...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#example">Example</a></li><li><a to="#description">Description</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#registry"><code>registry</code></a></li><li><a to="#otp"><code>otp</code></a></li><li><a to="#json"><code>json</code></a></li><li><a to="#parseable"><code>parseable</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<pre lang="bash"><code>$ npm org set my-org @mx-santos admin
</code></pre>
<p>Remove a user from an org:</p>
<pre lang="bash"><code>$ npm org rm my-org mx-santos
</code></pre>
<p>List all users in an org:</p>
<pre lang="bash"><code>$ npm org ls my-org
</code></pre>
<p>List all users in JSON format:</p>
<pre lang="bash"><code>$ npm org ls my-org --json
</code></pre>
<p>See what role a user has in an org:</p>
<pre lang="bash"><code>$ npm org ls my-org @mx-santos
</code></pre>
...
<ul>
<li><a to="../using-npm/orgs.html">using orgs</a></li>
<li><a to="https://docs.npmjs.com/orgs/">Documentation on npm Orgs</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-org.md">
