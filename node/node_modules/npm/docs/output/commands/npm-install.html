...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#save"><code>save</code></a></li><li><a to="#save-exact"><code>save-exact</code></a></li><li><a to="#global"><code>global</code></a></li><li><a to="#global-style"><code>global-style</code></a></li><li><a to="#legacy-bundling"><code>legacy-bundling</code></a></li><li><a to="#omit"><code>omit</code></a></li><li><a to="#strict-peer-deps"><code>strict-peer-deps</code></a></li><li><a to="#package-lock"><code>package-lock</code></a></li><li><a to="#foreground-scripts"><code>foreground-scripts</code></a></li><li><a to="#ignore-scripts"><code>ignore-scripts</code></a></li><li><a to="#audit"><code>audit</code></a></li><li><a to="#bin-links"><code>bin-links</code></a></li><li><a to="#fund"><code>fund</code></a></li><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li><li><a to="#install-links"><code>install-links</code></a></li></ul><li><a to="#algorithm">Algorithm</a></li><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<p>See <a to="../configuring-npm/package-lock-json.html">package-lock.json</a> and
<a to="../commands/npm-shrinkwrap.html"><code>npm shrinkwrap</code></a>.</p>
<p>A <code>package</code> is:</p>
<ul>
<li>a) a folder containing a program described by a
<a to="../configuring-npm/package-json.html"><code>package.json</code></a> file</li>
<li>b) a gzipped tarball containing (a)</li>
<li>c) a url that resolves to (b)</li>
<li>d) a <code>&lt;name&gt;@&lt;version&gt;</code> that is published on the registry (see
<a to="../using-npm/registry.html"><code>registry</code></a>) with (c)</li>
<li>e) a <code>&lt;name&gt;@&lt;tag&gt;</code> (see <a to="../commands/npm-dist-tag.html"><code>npm dist-tag</code></a>) that
points to (d)</li>
...
dependencies in <a to="../configuring-npm/package-json.html"><code>package.json</code></a>.</p>
...
easily by using <a to="../commands/npm-link.html"><code>npm link</code></a>.</p>
...
<a to="../using-npm/config.html"><code>config</code></a>. The config's default value is <code>latest</code>.)</p>
...
<a to="../using-npm/scope.html"><code>scope</code></a>.</p>
...
<a to="https://www.npmjs.com/package/validate-npm-package-name#naming-rules"><code>validate-npm-package-name</code></a>.</p>
<p>Examples:</p>
...
<a to="../configuring-npm/package-json.html"><code>package.json</code></a>.</p>
...
<p>See the <a to="../using-npm/config.html"><code>config</code></a> help doc.  Many of the configuration
...
a different order.</p>
<p>See <a to="../configuring-npm/folders.html">folders</a> for a more detailed description of
the specific folder structures that npm creates.</p>
<h3 id="see-also">See Also</h3>
<ul>
<li><a to="../configuring-npm/folders.html">npm folders</a></li>
<li><a to="../commands/npm-update.html">npm update</a></li>
<li><a to="../commands/npm-audit.html">npm audit</a></li>
<li><a to="../commands/npm-fund.html">npm fund</a></li>
<li><a to="../commands/npm-link.html">npm link</a></li>
<li><a to="../commands/npm-rebuild.html">npm rebuild</a></li>
...
<li><a to="../using-npm/registry.html">npm registry</a></li>
<li><a to="../commands/npm-dist-tag.html">npm dist-tag</a></li>
<li><a to="../commands/npm-uninstall.html">npm uninstall</a></li>
<li><a to="../commands/npm-shrinkwrap.html">npm shrinkwrap</a></li>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-install.md">
