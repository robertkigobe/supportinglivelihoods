...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#files-included-in-package">Files included in package</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#tag"><code>tag</code></a></li><li><a to="#access"><code>access</code></a></li><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#otp"><code>otp</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<a to="../using-npm/scope.html"><code>scope</code></a> in the name, combined with a
...
with <a to="../commands/npm-unpublish.html"><code>npm unpublish</code></a>.</p>
...
<p>Similar to <code>--dry-run</code> see <a to="../commands/npm-pack.html"><code>npm pack</code></a>, which figures
...
<a to="../configuring-npm/package-json.html"><code>package.json</code></a>, then only the files
...
<p><code>.npmignore</code> files follow the <a to="https://git-scm.com/book/en/v2/Git-Basics-Recording-Changes-to-the-Repository#_ignoring">same pattern
rules</a>
...
<p>See <a to="../using-npm/developers.html"><code>developers</code></a> for full details on what's
...
<ul>
<li><a to="../using-npm/package-spec.html">package spec</a></li>
<li><a to="http://npm.im/npm-packlist">npm-packlist package</a></li>
<li><a to="../using-npm/registry.html">npm registry</a></li>
<li><a to="../using-npm/scope.html">npm scope</a></li>
<li><a to="../commands/npm-adduser.html">npm adduser</a></li>
<li><a to="../commands/npm-owner.html">npm owner</a></li>
<li><a to="../commands/npm-deprecate.html">npm deprecate</a></li>
<li><a to="../commands/npm-dist-tag.html">npm dist-tag</a></li>
<li><a to="../commands/npm-pack.html">npm pack</a></li>
<li><a to="../commands/npm-profile.html">npm profile</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-publish.md">
