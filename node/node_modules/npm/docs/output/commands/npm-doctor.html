...
<span class="description">Check your npm environment</span>
</header>

<section id="table_of_contents">
<h2 id="table-of-contents">Table of contents</h2>
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><ul><li><a to="#npm-ping"><code>npm ping</code></a></li><li><a to="#npm--v"><code>npm -v</code></a></li><li><a to="#node--v"><code>node -v</code></a></li><li><a to="#npm-config-get-registry"><code>npm config get registry</code></a></li><li><a to="#which-git"><code>which git</code></a></li><li><a to="#permissions-checks">Permissions checks</a></li><li><a to="#validate-the-checksums-of-cached-packages">Validate the checksums of cached packages</a></li></ul><li><a to="#configuration">Configuration</a></li><ul><li><a to="#registry"><code>registry</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<ul>
<li><a to="../commands/npm-bugs.html">npm bugs</a></li>
<li><a to="../commands/npm-help.html">npm help</a></li>
<li><a to="../commands/npm-ping.html">npm ping</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-doctor.md">
