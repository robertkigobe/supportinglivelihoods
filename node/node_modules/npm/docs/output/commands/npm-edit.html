...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#editor"><code>editor</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
config -- see <a to="npm-config"><code>npm-config</code></a>.)</p>
...
<li><a to="../commands/npm-explore.html">npm explore</a></li>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-edit.md">
