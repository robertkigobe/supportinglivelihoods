...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#version">Version</a></li><li><a to="#description">Description</a></li><li><a to="#important">Important</a></li><li><a to="#introduction">Introduction</a></li><li><a to="#dependencies">Dependencies</a></li><li><a to="#directories">Directories</a></li><li><a to="#developer-usage">Developer Usage</a></li><ul><li><a to="#configuration">Configuration</a></li></ul><li><a to="#contributions">Contributions</a></li><li><a to="#bugs">Bugs</a></li><li><a to="#feature-requests">Feature Requests</a></li><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<a to="https://registry.npmjs.org">https://registry.npmjs.org</a> by default. Use of the npm public registry is
subject to terms of use available at
<a to="https://docs.npmjs.com/policies/terms">https://docs.npmjs.com/policies/terms</a>.</p>
...
"blerg".  Check out <a to="../commands/npm-install.html"><code>npm install</code></a> for more
...
dependency using the <a to="https://github.com/git-guides/install-git"><code>git</code></a>
...
<a to="https://github.com/nodejs/node-gyp">node-gyp</a> for that task.
For a Unix system, <a to="https://github.com/nodejs/node-gyp">node-gyp</a>
needs Python, make and a buildchain like GCC. On Windows,
Python and Microsoft Visual Studio C++ are needed. For more information
visit <a to="https://github.com/nodejs/node-gyp">the node-gyp repository</a> and
the <a to="https://github.com/nodejs/node-gyp/wiki">node-gyp Wiki</a>.</p>
<h3 id="directories">Directories</h3>
<p>See <a to="../configuring-npm/folders.html"><code>folders</code></a> to learn about where npm puts
stuff.</p>
...
<a to="../configuring-npm/package-json.html"><code>package.json</code></a>.</li>
<li>link:
Links your current working code into Node's path, so that you don't
have to reinstall every time you make a change.  Use <a to="../commands/npm-link.html"><code>npm link</code></a> to do this.</li>
<li>install:
...
done via <a to="../commands/npm-install.html"><code>npm install</code></a></li>
<li>adduser:
Create an account or log in.  When you do this, npm will store
credentials in the user config file.</li>
<li>publish:
Use the <a to="../commands/npm-publish.html"><code>npm publish</code></a> command to upload your
...
parsed if it is found.  See <a to="../commands/npm-prefix.html"><code>npm prefix</code></a> for
...
<p>See <a to="../using-npm/config.html"><code>config</code></a> for much much more information.</p>
<h3 id="contributions">Contributions</h3>
<p>Patches welcome!</p>
<p>If you would like to help, but don't know what to work on, read the
<a to="https://github.com/npm/cli/blob/latest/CONTRIBUTING.md">contributing
guidelines</a> and
check the issues list.</p>
<h3 id="bugs">Bugs</h3>
<p>When you find issues, please report them:
<a to="https://github.com/npm/cli/issues">https://github.com/npm/cli/issues</a></p>
...
<ul>
<li><a to="https://github.com/npm/feedback">https://github.com/npm/feedback</a></li>
</ul>
<p>Or suggest formal RFC proposals:</p>
<ul>
<li><a to="https://github.com/npm/rfcs">https://github.com/npm/rfcs</a></li>
</ul>
...
<li><a to="../commands/npm-prefix.html">npm prefix</a></li>
<li><a to="../commands/npm-publish.html">npm publish</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm.md">
