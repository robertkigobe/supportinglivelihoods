...
<p>Unlike with <a to="../commands/npm-start.html">npm start</a>, there is no default script
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-stop.md">
