...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#sub-commands">Sub-commands</a></li><ul><li><a to="#set">set</a></li><li><a to="#get">get</a></li><li><a to="#list">list</a></li><li><a to="#delete">delete</a></li><li><a to="#edit2">edit</a></li></ul><li><a to="#configuration">Configuration</a></li><ul><li><a to="#json"><code>json</code></a></li><li><a to="#global"><code>global</code></a></li><li><a to="#editor"><code>editor</code></a></li><li><a to="#location"><code>location</code></a></li><li><a to="#long"><code>long</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<p>See <a to="../configuring-npm/npmrc.html">npmrc</a> for more information about the npmrc
files.</p>
<p>See <a to="../using-npm/config.html">config(7)</a> for a more thorough explanation of the
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-config.md">
