...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#audit-signatures">Audit Signatures</a></li><li><a to="#audit-endpoints">Audit Endpoints</a></li><ul><li><a to="#bulk-advisory-endpoint">Bulk Advisory Endpoint</a></li><li><a to="#quick-audit-endpoint">Quick Audit Endpoint</a></li><li><a to="#scrubbing">Scrubbing</a></li><li><a to="#calculating-meta-vulnerabilities-and-remediations">Calculating Meta-Vulnerabilities and Remediations</a></li></ul><li><a to="#exit-code">Exit Code</a></li><li><a to="#examples">Examples</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#audit-level"><code>audit-level</code></a></li><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#force"><code>force</code></a></li><li><a to="#json"><code>json</code></a></li><li><a to="#package-lock-only"><code>package-lock-only</code></a></li><li><a to="#omit"><code>omit</code></a></li><li><a to="#foreground-scripts"><code>foreground-scripts</code></a></li><li><a to="#ignore-scripts"><code>ignore-scripts</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li><li><a to="#install-links"><code>install-links</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<p>See this <a to="https://registry.npmjs.org/light-cycle/1.4.3">example</a> of a signed package from the public npm registry.</p>
...
<p>npm uses the
<a to="http://npm.im/@npmcli/metavuln-calculator"><code>@npmcli/metavuln-calculator</code></a>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-audit.md">
