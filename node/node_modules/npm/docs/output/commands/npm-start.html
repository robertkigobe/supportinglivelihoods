...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#example">Example</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#ignore-scripts"><code>ignore-scripts</code></a></li><li><a to="#script-shell"><code>script-shell</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<code>node .</code></p>
<p>As of <a to="https://blog.npmjs.org/post/98131109725/npm-2-0-0"><code>npm@2.0.0</code></a>, you can
use custom arguments when executing scripts. Refer to <a to="../commands/npm-run-script.html"><code>npm run-script</code></a> for more details.</p>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-start.md">
