...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#npx-vs-npm-exec"><code>npx</code> vs <code>npm exec</code></a></li><li><a to="#examples">Examples</a></li><li><a to="#compatibility-with-older-npx-versions">Compatibility with Older npx Versions</a></li><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npx.md">
