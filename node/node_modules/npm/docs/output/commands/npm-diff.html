...
<a to="npm-outdated"><code>npm-outdated</code></a> and reach for the registry to figure out
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-diff.md">
