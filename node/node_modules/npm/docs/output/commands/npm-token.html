...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#read-only"><code>read-only</code></a></li><li><a to="#cidr"><code>cidr</code></a></li><li><a to="#registry"><code>registry</code></a></li><li><a to="#otp"><code>otp</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
a list of
<a to="https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing">CIDR</a>
...
the <a to="https://docs.npmjs.com/creating-and-viewing-access-tokens">docs
website</a>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-token.md">
