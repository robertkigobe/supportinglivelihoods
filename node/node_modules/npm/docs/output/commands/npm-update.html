...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#example">Example</a></li><ul><li><a to="#caret-dependencies">Caret Dependencies</a></li><li><a to="#tilde-dependencies">Tilde Dependencies</a></li><li><a to="#caret-dependencies-below-100">Caret Dependencies below 1.0.0</a></li><li><a to="#subdependencies">Subdependencies</a></li><li><a to="#updating-globally-installed-packages">Updating Globally-Installed Packages</a></li></ul><li><a to="#configuration">Configuration</a></li><ul><li><a to="#save"><code>save</code></a></li><li><a to="#global"><code>global</code></a></li><li><a to="#global-style"><code>global-style</code></a></li><li><a to="#legacy-bundling"><code>legacy-bundling</code></a></li><li><a to="#omit"><code>omit</code></a></li><li><a to="#strict-peer-deps"><code>strict-peer-deps</code></a></li><li><a to="#package-lock"><code>package-lock</code></a></li><li><a to="#foreground-scripts"><code>foreground-scripts</code></a></li><li><a to="#ignore-scripts"><code>ignore-scripts</code></a></li><li><a to="#audit"><code>audit</code></a></li><li><a to="#bin-links"><code>bin-links</code></a></li><li><a to="#fund"><code>fund</code></a></li><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li><li><a to="#install-links"><code>install-links</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<code>save=true</code> option to a <a to="../configuring-npm/npmrc.html">configuration file</a>
...
<li><a to="../commands/npm-outdated.html">npm outdated</a></li>
...
<li><a to="../commands/npm-ls.html">npm ls</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-update.md">
