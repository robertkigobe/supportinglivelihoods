...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#example">Example</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#registry"><code>registry</code></a></li><li><a to="#otp"><code>otp</code></a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
<p>Allows you to manage <a to="https://blog.npmjs.org/post/145260155635/introducing-hooks-get-notifications-of-npm">npm
hooks</a>,
...
<pre lang="bash"><code>$ npm hook add lodash https://example.com/ my-shared-secret
</code></pre>
<p>Add a hook to watch packages belonging to the user <code>substack</code>:</p>
<pre lang="bash"><code>$ npm hook add ~substack https://example.com/ my-shared-secret
</code></pre>
<p>Add a hook to watch packages in the scope <code>@npm</code></p>
<pre lang="bash"><code>$ npm hook add @npm https://example.com/ my-shared-secret
</code></pre>
<p>List all your active hooks:</p>
<pre lang="bash"><code>$ npm hook ls
</code></pre>
...
<ul>
<li><a to="https://blog.npmjs.org/post/145260155635/introducing-hooks-get-notifications-of-npm">"Introducing Hooks" blog post</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-hook.md">
