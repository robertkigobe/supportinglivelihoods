...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#description">Description</a></li><li><a to="#npx-vs-npm-exec"><code>npx</code> vs <code>npm exec</code></a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#package"><code>package</code></a></li><li><a to="#call"><code>call</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li></ul><li><a to="#examples">Examples</a></li><li><a to="#workspaces-support">Workspaces support</a></li><ul><li><a to="#filtering-workspaces">Filtering workspaces</a></li></ul><li><a to="#compatibility-with-older-npx-versions">Compatibility with Older npx Versions</a></li><li><a to="#a-note-on-caching">A note on caching</a></li><ul><li><a to="#prefer-online">prefer-online</a></li><li><a to="#prefer-offline">prefer-offline</a></li><li><a to="#offline">offline</a></li><li><a to="#workspace2">workspace</a></li><li><a to="#workspaces2">workspaces</a></li></ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
cli uses this cache. See <a to="../commands/npm-cache.html"><code>npm cache</code></a> for more on
...
<li><a to="../commands/npm-test.html">npm test</a></li>
<li><a to="../commands/npm-start.html">npm start</a></li>
<li><a to="../commands/npm-restart.html">npm restart</a></li>
<li><a to="../commands/npm-stop.html">npm stop</a></li>
<li><a to="../commands/npm-config.html">npm config</a></li>
<li><a to="../using-npm/workspaces.html">npm workspaces</a></li>
<li><a to="../commands/npx.html">npx</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-exec.md">
