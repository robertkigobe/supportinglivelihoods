...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#configuration">Configuration</a></li><ul><li><a to="#allow-same-version"><code>allow-same-version</code></a></li><li><a to="#commit-hooks"><code>commit-hooks</code></a></li><li><a to="#git-tag-version"><code>git-tag-version</code></a></li><li><a to="#json"><code>json</code></a></li><li><a to="#preid"><code>preid</code></a></li><li><a to="#sign-git-tag"><code>sign-git-tag</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#workspaces-update"><code>workspaces-update</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li></ul><li><a to="#description">Description</a></li><li><a to="#see-also">See Also</a></li></ul></div>
</section>
...
argument to <a to="https://github.com/npm/node-semver#functions">semver.inc</a> (one
...
<p>If supplied with <code>-m</code> or <code>--message</code> config option, npm will use it as a
commit message when creating a version commit.  If the <code>message</code> config
contains <code>%s</code> then that will be replaced with the resulting version number.
For example:</p>
<pre lang="bash"><code>npm version patch -m "Upgrade to %s for reasons"
</code></pre>
<p>If the <code>sign-git-tag</code> config is set, then the tag will be signed using the
<code>-s</code> flag to git.  Note that you must have a default GPG key set up in your
git config for this to work properly.  For example:</p>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-version.md">
