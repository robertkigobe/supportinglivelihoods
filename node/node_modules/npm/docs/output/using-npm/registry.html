...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#does-npm-send-any-information-about-me-back-to-the-registry">Does npm send any information about me back to the registry?</a></li><li><a to="#how-can-i-prevent-my-package-from-being-published-in-the-official-registry">How can I prevent my package from being published in the official registry?</a></li><li><a to="#where-can-i-find-my-own--others-published-packages">Where can I find my own, &amp; other's, published packages?</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
subject to terms of use available at <a to="https://docs.npmjs.com/policies/terms">https://docs.npmjs.com/policies/terms</a>.</p>
...
of which there is a public mirror at <a to="https://skimdb.npmjs.com/registry">https://skimdb.npmjs.com/registry</a>.</p>
<p>The registry URL used is determined by the scope of the package (see
<a to="../using-npm/scope.html"><code>scope</code></a>. If no scope is specified, the default registry is used, which is
supplied by the <code>registry</code> config parameter.  See <a to="../commands/npm-config.html"><code>npm config</code></a>,
<a to="../configuring-npm/npmrc.html"><code>npmrc</code></a>, and <a to="../using-npm/config.html"><code>config</code></a> for more on managing npm's configuration.</p>
...
the <a to="https://github.com/npm/npm-registry-client/pull/129">original PR</a>
interesting.
...
<p>See <a to="../configuring-npm/package-json.html"><code>package.json</code></a> for more info on what goes in the package.json file.</p>
<h3 id="where-can-i-find-my-own--others-published-packages">Where can I find my own, &amp; other's, published packages?</h3>
<p><a to="https://www.npmjs.com/">https://www.npmjs.com/</a></p>
<h3 id="see-also">See also</h3>
<ul>
<li><a to="../commands/npm-config.html">npm config</a></li>
<li><a to="../using-npm/config.html">config</a></li>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/registry.md">
