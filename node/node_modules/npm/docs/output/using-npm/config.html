...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><ul><li><a to="#command-line-flags">Command Line Flags</a></li><li><a to="#environment-variables">Environment Variables</a></li><li><a to="#npmrc-files">npmrc Files</a></li><li><a to="#default-configs">Default Configs</a></li></ul><li><a to="#shorthands-and-other-cli-niceties">Shorthands and Other CLI Niceties</a></li><li><a to="#config-settings">Config Settings</a></li><ul><li><a to="#auth"><code>_auth</code></a></li><li><a to="#access"><code>access</code></a></li><li><a to="#all"><code>all</code></a></li><li><a to="#allow-same-version"><code>allow-same-version</code></a></li><li><a to="#audit"><code>audit</code></a></li><li><a to="#audit-level"><code>audit-level</code></a></li><li><a to="#auth-type"><code>auth-type</code></a></li><li><a to="#before"><code>before</code></a></li><li><a to="#bin-links"><code>bin-links</code></a></li><li><a to="#browser"><code>browser</code></a></li><li><a to="#ca"><code>ca</code></a></li><li><a to="#cache"><code>cache</code></a></li><li><a to="#cafile"><code>cafile</code></a></li><li><a to="#call"><code>call</code></a></li><li><a to="#cert"><code>cert</code></a></li><li><a to="#ci-name"><code>ci-name</code></a></li><li><a to="#cidr"><code>cidr</code></a></li><li><a to="#color"><code>color</code></a></li><li><a to="#commit-hooks"><code>commit-hooks</code></a></li><li><a to="#depth"><code>depth</code></a></li><li><a to="#description2"><code>description</code></a></li><li><a to="#diff"><code>diff</code></a></li><li><a to="#diff-dst-prefix"><code>diff-dst-prefix</code></a></li><li><a to="#diff-ignore-all-space"><code>diff-ignore-all-space</code></a></li><li><a to="#diff-name-only"><code>diff-name-only</code></a></li><li><a to="#diff-no-prefix"><code>diff-no-prefix</code></a></li><li><a to="#diff-src-prefix"><code>diff-src-prefix</code></a></li><li><a to="#diff-text"><code>diff-text</code></a></li><li><a to="#diff-unified"><code>diff-unified</code></a></li><li><a to="#dry-run"><code>dry-run</code></a></li><li><a to="#editor"><code>editor</code></a></li><li><a to="#engine-strict"><code>engine-strict</code></a></li><li><a to="#fetch-retries"><code>fetch-retries</code></a></li><li><a to="#fetch-retry-factor"><code>fetch-retry-factor</code></a></li><li><a to="#fetch-retry-maxtimeout"><code>fetch-retry-maxtimeout</code></a></li><li><a to="#fetch-retry-mintimeout"><code>fetch-retry-mintimeout</code></a></li><li><a to="#fetch-timeout"><code>fetch-timeout</code></a></li><li><a to="#force"><code>force</code></a></li><li><a to="#foreground-scripts"><code>foreground-scripts</code></a></li><li><a to="#format-package-lock"><code>format-package-lock</code></a></li><li><a to="#fund"><code>fund</code></a></li><li><a to="#git"><code>git</code></a></li><li><a to="#git-tag-version"><code>git-tag-version</code></a></li><li><a to="#global"><code>global</code></a></li><li><a to="#global-style"><code>global-style</code></a></li><li><a to="#globalconfig"><code>globalconfig</code></a></li><li><a to="#heading"><code>heading</code></a></li><li><a to="#https-proxy"><code>https-proxy</code></a></li><li><a to="#if-present"><code>if-present</code></a></li><li><a to="#ignore-scripts"><code>ignore-scripts</code></a></li><li><a to="#include"><code>include</code></a></li><li><a to="#include-staged"><code>include-staged</code></a></li><li><a to="#include-workspace-root"><code>include-workspace-root</code></a></li><li><a to="#init-author-email"><code>init-author-email</code></a></li><li><a to="#init-author-name"><code>init-author-name</code></a></li><li><a to="#init-author-url"><code>init-author-url</code></a></li><li><a to="#init-license"><code>init-license</code></a></li><li><a to="#init-module"><code>init-module</code></a></li><li><a to="#init-version"><code>init-version</code></a></li><li><a to="#install-links"><code>install-links</code></a></li><li><a to="#json"><code>json</code></a></li><li><a to="#key"><code>key</code></a></li><li><a to="#legacy-bundling"><code>legacy-bundling</code></a></li><li><a to="#legacy-peer-deps"><code>legacy-peer-deps</code></a></li><li><a to="#link"><code>link</code></a></li><li><a to="#local-address"><code>local-address</code></a></li><li><a to="#location"><code>location</code></a></li><li><a to="#lockfile-version"><code>lockfile-version</code></a></li><li><a to="#loglevel"><code>loglevel</code></a></li><li><a to="#logs-dir"><code>logs-dir</code></a></li><li><a to="#logs-max"><code>logs-max</code></a></li><li><a to="#long"><code>long</code></a></li><li><a to="#maxsockets"><code>maxsockets</code></a></li><li><a to="#message"><code>message</code></a></li><li><a to="#node-options"><code>node-options</code></a></li><li><a to="#node-version"><code>node-version</code></a></li><li><a to="#noproxy"><code>noproxy</code></a></li><li><a to="#npm-version"><code>npm-version</code></a></li><li><a to="#offline"><code>offline</code></a></li><li><a to="#omit"><code>omit</code></a></li><li><a to="#omit-lockfile-registry-resolved"><code>omit-lockfile-registry-resolved</code></a></li><li><a to="#otp"><code>otp</code></a></li><li><a to="#pack-destination"><code>pack-destination</code></a></li><li><a to="#package"><code>package</code></a></li><li><a to="#package-lock"><code>package-lock</code></a></li><li><a to="#package-lock-only"><code>package-lock-only</code></a></li><li><a to="#parseable"><code>parseable</code></a></li><li><a to="#prefer-offline"><code>prefer-offline</code></a></li><li><a to="#prefer-online"><code>prefer-online</code></a></li><li><a to="#prefix"><code>prefix</code></a></li><li><a to="#preid"><code>preid</code></a></li><li><a to="#progress"><code>progress</code></a></li><li><a to="#proxy"><code>proxy</code></a></li><li><a to="#read-only"><code>read-only</code></a></li><li><a to="#rebuild-bundle"><code>rebuild-bundle</code></a></li><li><a to="#registry"><code>registry</code></a></li><li><a to="#replace-registry-host"><code>replace-registry-host</code></a></li><li><a to="#save"><code>save</code></a></li><li><a to="#save-bundle"><code>save-bundle</code></a></li><li><a to="#save-dev"><code>save-dev</code></a></li><li><a to="#save-exact"><code>save-exact</code></a></li><li><a to="#save-optional"><code>save-optional</code></a></li><li><a to="#save-peer"><code>save-peer</code></a></li><li><a to="#save-prefix"><code>save-prefix</code></a></li><li><a to="#save-prod"><code>save-prod</code></a></li><li><a to="#scope"><code>scope</code></a></li><li><a to="#script-shell"><code>script-shell</code></a></li><li><a to="#searchexclude"><code>searchexclude</code></a></li><li><a to="#searchlimit"><code>searchlimit</code></a></li><li><a to="#searchopts"><code>searchopts</code></a></li><li><a to="#searchstaleness"><code>searchstaleness</code></a></li><li><a to="#shell"><code>shell</code></a></li><li><a to="#sign-git-commit"><code>sign-git-commit</code></a></li><li><a to="#sign-git-tag"><code>sign-git-tag</code></a></li><li><a to="#strict-peer-deps"><code>strict-peer-deps</code></a></li><li><a to="#strict-ssl"><code>strict-ssl</code></a></li><li><a to="#tag"><code>tag</code></a></li><li><a to="#tag-version-prefix"><code>tag-version-prefix</code></a></li><li><a to="#timing"><code>timing</code></a></li><li><a to="#umask"><code>umask</code></a></li><li><a to="#unicode"><code>unicode</code></a></li><li><a to="#update-notifier"><code>update-notifier</code></a></li><li><a to="#usage"><code>usage</code></a></li><li><a to="#user-agent"><code>user-agent</code></a></li><li><a to="#userconfig"><code>userconfig</code></a></li><li><a to="#version"><code>version</code></a></li><li><a to="#versions"><code>versions</code></a></li><li><a to="#viewer"><code>viewer</code></a></li><li><a to="#which"><code>which</code></a></li><li><a to="#workspace"><code>workspace</code></a></li><li><a to="#workspaces"><code>workspaces</code></a></li><li><a to="#workspaces-update"><code>workspaces-update</code></a></li><li><a to="#yes"><code>yes</code></a></li><li><a to="#also"><code>also</code></a></li><li><a to="#cache-max"><code>cache-max</code></a></li><li><a to="#cache-min"><code>cache-min</code></a></li><li><a to="#dev"><code>dev</code></a></li><li><a to="#initauthoremail"><code>init.author.email</code></a></li><li><a to="#initauthorname"><code>init.author.name</code></a></li><li><a to="#initauthorurl"><code>init.author.url</code></a></li><li><a to="#initlicense"><code>init.license</code></a></li><li><a to="#initmodule"><code>init.module</code></a></li><li><a to="#initversion"><code>init.version</code></a></li><li><a to="#only"><code>only</code></a></li><li><a to="#optional"><code>optional</code></a></li><li><a to="#production"><code>production</code></a></li><li><a to="#shrinkwrap"><code>shrinkwrap</code></a></li><li><a to="#sso-poll-frequency"><code>sso-poll-frequency</code></a></li><li><a to="#sso-type"><code>sso-type</code></a></li><li><a to="#tmp"><code>tmp</code></a></li></ul><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
same. However, please note that inside <a to="../using-npm/scripts.html"><code>scripts</code></a>
npm will set its own environment variables and Node will prefer
those lowercase versions over any uppercase ones that you might set.
For details see <a to="https://github.com/npm/npm/issues/14528">this issue</a>.</p>
...
<p>See <a to="../configuring-npm/npmrc.html">npmrc</a> for more details.</p>
...
documentation for <a to="../commands/npm-audit.html"><code>npm audit</code></a> for details on what is
submitted.</p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
<p>The location of npm's cache directory. See <a to="../commands/npm-cache.html"><code>npm cache</code></a></p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
<a to="http://npm.im/@npmcli/ci-detect"><code>@npmcli/ci-detect</code></a> module.</p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
acknowledging the number of dependencies looking for funding. See <a to="../commands/npm-fund.html"><code>npm fund</code></a> for details.</p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
<a to="../configuring-npm/folders.html">folders</a> for more on the differences in behavior.</p>
<ul>
...
<p>Allow installing "staged" published packages, as defined by <a to="https://github.com/npm/rfcs/pull/92">npm RFC PR
#92</a>.</p>
...
<a to="https://github.com/npm/init-package-json">init-package-json</a> module for
more information, or <a to="../commands/npm-init.html">npm init</a>.</p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
<p>The location of npm's log directory. See <a to="../using-npm/logging.html"><code>npm logging</code></a>
...
<p>The package or packages to install for <a to="../commands/npm-exec.html"><code>npm exec</code></a></p>
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
...
<ul>
<li>Default: "<a to="https://registry.npmjs.org/">https://registry.npmjs.org/</a>"</li>
<li>Type: URL</li>
</ul>
...
registry (<a to="https://registry.npmjs.org">https://registry.npmjs.org</a>) to the configured registry. If set to
...
<p>You can quickly view it with this <a to="https://npm.im/json">json</a> command line:
...
<a to="https://nodejs.org/api/os.html#os_os_tmpdir">https://nodejs.org/api/os.html#os_os_tmpdir</a></li>
<li>Type: Path</li>
...
<a to="http://npm.im/cacache"><code>cacache</code></a>.</li>
</ul>
...
<ul>
<li><a to="../commands/npm-config.html">npm config</a></li>
<li><a to="../configuring-npm/npmrc.html">npmrc</a></li>
<li><a to="../using-npm/scripts.html">npm scripts</a></li>
<li><a to="../configuring-npm/folders.html">npm folders</a></li>
<li><a to="../commands/npm.html">npm</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/config.md">
