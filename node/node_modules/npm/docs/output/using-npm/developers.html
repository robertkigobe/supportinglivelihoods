...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#about-these-documents">About These Documents</a></li><li><a to="#what-is-a-package">What is a Package</a></li><li><a to="#the-packagejson-file">The package.json File</a></li><li><a to="#keeping-files-out-of-your-package">Keeping files <em>out</em> of your Package</a></li><ul><li><a to="#testing-whether-your-npmignore-or-files-config-works">Testing whether your <code>.npmignore</code> or <code>files</code> config works</a></li></ul><li><a to="#link-packages">Link Packages</a></li><li><a to="#before-publishing-make-sure-your-package-installs-and-works">Before Publishing: Make Sure Your Package Installs and Works</a></li><li><a to="#create-a-user-account">Create a User Account</a></li><li><a to="#publish-your-package">Publish your Package</a></li><li><a to="#brag-about-it">Brag about it</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
<p>See <a to="../configuring-npm/package-json.html"><code>package.json</code></a> for details about what
...
<a to="../using-npm/scripts.html">scripts</a>.</p>
</li>
<li>
...
started with a pretty basic package.json file.  See <a to="../commands/npm-init.html"><code>npm init</code></a> for more info.</p>
...
of course.)</p>
<p>More info at <a to="../commands/npm-link.html"><code>npm link</code></a>.</p>
...
<p>This is documented better in <a to="../commands/npm-adduser.html">npm adduser</a>.</p>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/developers.md">
