...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#defining-workspaces">Defining workspaces</a></li><li><a to="#getting-started-with-workspaces">Getting started with workspaces</a></li><li><a to="#adding-dependencies-to-a-workspace">Adding dependencies to a workspace</a></li><li><a to="#using-workspaces">Using workspaces</a></li><li><a to="#running-commands-in-the-context-of-workspaces">Running commands in the context of workspaces</a></li><li><a to="#ignoring-missing-scripts">Ignoring missing scripts</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
file system that is explicitly defined in the <a to="../configuring-npm/package-json#workspaces.html"><code>package.json</code></a>
...
<a to="../configuring-npm/package-json#workspaces.html"><code>package.json</code></a> file, e.g:</p>
<pre lang="json"><code>{
...
<a to="../commands/npm-init.html">npm init</a>. For example in a project that already has a
...
using the <a to="../using-npm/config#workspace.html"><code>workspace</code> config</a>.</p>
...
<p>Given the <a to="https://nodejs.org/dist/latest-v14.x/docs/api/modules.html#modules_all_together">specifities of how Node.js handles module resolution</a> it's possible to consume any defined workspace
...
in such a way that is also easy to <a to="../commands/npm-publish.html">publish</a> these
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/workspaces.md">
