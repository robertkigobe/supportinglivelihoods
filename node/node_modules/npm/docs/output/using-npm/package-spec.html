...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#package-name">Package name</a></li><li><a to="#aliases">Aliases</a></li><li><a to="#folders">Folders</a></li><li><a to="#tarballs">Tarballs</a></li><li><a to="#git-urls">git urls</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
with the <a to="../using-npm/config#registry.html">registry</a> config to refer to a
...
name, and <a to="../using-npm/config#registry.html">registry</a> for configuring which
...
<p><a to="https://npm.im/npm-package-arg">npm-package-arg</a>
<a to="../using-npm/scope.html">scope</a>
<a to="../using-npm/config.html">config</a></p>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/package-spec.md">
