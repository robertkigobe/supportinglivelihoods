...
<div id="_table_of_contents"><ul><li><a to="#see-also">See Also</a></li></ul></div>
</section>

<div id="_content"><h3 id="description">Description</h3>
<p>The <a to="../commands/npm-query.html"><code>npm query</code></a> commmand exposes a new dependency selector syntax (informed by &amp; respecting many aspects of the <a to="https://dev.w3.org/csswg/selectors4/#relational">CSS Selectors 4 Spec</a>) which:</p>
<ul>
...
<li><code>.workspace</code> dependency found in the <a to="https://docs.npmjs.com/cli/v8/using-npm/workspaces"><code>workspaces</code></a> section of <code>package.json</code></li>
...
<ul>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:not"><code>:not(&lt;selector&gt;)</code></a></li>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:has"><code>:has(&lt;selector&gt;)</code></a></li>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:is"><code>:is(&lt;selector list&gt;)</code></a></li>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:root"><code>:root</code></a> matches the root node/dependency</li>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:scope"><code>:scope</code></a> matches node/dependency it was queried against</li>
<li><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/:empty"><code>:empty</code></a> when a dependency has no dependencies</li>
<li><a to="https://docs.npmjs.com/cli/v8/configuring-npm/package-json#private"><code>:private</code></a> when a dependency is private</li>
<li><code>:link</code> when a dependency is linked (for instance, workspaces or packages manually <a to="https://docs.npmjs.com/cli/v8/commands/npm-link"><code>linked</code></a></li>
...
<li><code>:semver(&lt;spec&gt;)</code> matching a valid <a to="https://github.com/npm/node-semver"><code>node-semver</code></a> spec</li>
<li><code>:path(&lt;path&gt;)</code> <a to="https://www.npmjs.com/package/glob">glob</a> matching based on dependencies path relative to the project</li>
<li><code>:type(&lt;type&gt;)</code> <a to="https://github.com/npm/npm-package-arg#result-object">based on currently recognized types</a></li>
</ul>
<h4 id="attribute-selectors"><a to="https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors">Attribute Selectors</a></h4>
...
<ul>
<li><a to="../commands/npm-query.html">npm query</a></li>
<li><a to="https://npm.im/@npmcli/arborist">@npmcli/arborist</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/dependency-selectors.md">
