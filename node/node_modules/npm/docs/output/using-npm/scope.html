...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#installing-scoped-packages">Installing scoped packages</a></li><li><a to="#requiring-scoped-packages">Requiring scoped packages</a></li><li><a to="#publishing-scoped-packages">Publishing scoped packages</a></li><ul><li><a to="#publishing-public-scoped-packages-to-the-primary-npm-registry">Publishing public scoped packages to the primary npm registry</a></li><li><a to="#publishing-private-scoped-packages-to-the-npm-registry">Publishing private scoped packages to the npm registry</a></li></ul><li><a to="#associating-a-scope-with-a-registry">Associating a scope with a registry</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
install from GitHub; see <a to="../commands/npm-install.html"><code>npm install</code></a>.</p>
...
an <a to="https://docs.npmjs.com/private-modules/intro">npm Private Modules</a>
account.</p>
...
private registries, such as <a to="https://github.com/features/packages">GitHub Packages</a> or the open source <a to="https://verdaccio.org">Verdaccio</a>
project.</p>
...
<li><a to="../commands/npm-access.html">npm access</a></li>
<li><a to="../using-npm/registry.html">npm registry</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/scope.md">
