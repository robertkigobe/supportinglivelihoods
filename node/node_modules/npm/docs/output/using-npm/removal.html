...
<div id="_table_of_contents"><ul><li><a to="#synopsis">Synopsis</a></li><li><a to="#more-severe-uninstalling">More Severe Uninstalling</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/using-npm/removal.md">
