...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#package-lockjson-vs-npm-shrinkwrapjson"><code>package-lock.json</code> vs <code>npm-shrinkwrap.json</code></a></li><li><a to="#hidden-lockfiles">Hidden Lockfiles</a></li><li><a to="#handling-old-lockfiles">Handling Old Lockfiles</a></li><li><a to="#file-format">File Format</a></li><ul><li><a to="#name"><code>name</code></a></li><li><a to="#version"><code>version</code></a></li><li><a to="#lockfileversion"><code>lockfileVersion</code></a></li><li><a to="#packages"><code>packages</code></a></li><li><a to="#dependencies">dependencies</a></li></ul><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
<p>In contrast, <a to="../configuring-npm/npm-shrinkwrap-json.html">npm-shrinkwrap.json</a> allows
...
<li>
<p>integrity: A <code>sha512</code> or <code>sha1</code> <a to="https://w3c.github.io/webappsec/specs/subresourceintegrity/">Standard Subresource
Integrity</a>
...
<li><a to="../configuring-npm/npm-shrinkwrap-json.html">npm-shrinkwrap.json</a></li>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/package-lock-json.md">
