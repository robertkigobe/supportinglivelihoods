...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><ul><li><a to="#tldr">tl;dr</a></li><li><a to="#prefix-configuration">prefix Configuration</a></li><li><a to="#node-modules">Node Modules</a></li><li><a to="#executables">Executables</a></li><li><a to="#man-pages">Man Pages</a></li><li><a to="#cache">Cache</a></li><li><a to="#temp-files">Temp Files</a></li></ul><li><a to="#more-information">More Information</a></li><ul><li><a to="#global-installation">Global Installation</a></li><li><a to="#cycles-conflicts-and-folder-parsimony">Cycles, Conflicts, and Folder Parsimony</a></li><li><a to="#example">Example</a></li><li><a to="#publishing">Publishing</a></li></ul><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
<a to="../using-npm/scope.html"><code>scope</code></a> for more details.</p>
...
<p>See <a to="../commands/npm-cache.html"><code>npm cache</code></a>.  Cache files are stored in <code>~/.npm</code> on Posix, or
...
cannot be found elsewhere.  See <a to="../configuring-npm/package-json.html"><code>package.json</code></a> for more information.</p>
...
<li><a to="../commands/npm-cache.html">npm cache</a></li>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/folders.md">
