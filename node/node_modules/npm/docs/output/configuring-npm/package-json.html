...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#name">name</a></li><li><a to="#version">version</a></li><li><a to="#description2">description</a></li><li><a to="#keywords">keywords</a></li><li><a to="#homepage">homepage</a></li><li><a to="#bugs">bugs</a></li><li><a to="#license">license</a></li><li><a to="#people-fields-author-contributors">people fields: author, contributors</a></li><li><a to="#funding">funding</a></li><li><a to="#files">files</a></li><li><a to="#main">main</a></li><li><a to="#browser">browser</a></li><li><a to="#bin">bin</a></li><li><a to="#man">man</a></li><li><a to="#directories">directories</a></li><ul><li><a to="#directoriesbin">directories.bin</a></li><li><a to="#directoriesman">directories.man</a></li></ul><li><a to="#repository">repository</a></li><li><a to="#scripts">scripts</a></li><li><a to="#config">config</a></li><li><a to="#dependencies">dependencies</a></li><ul><li><a to="#urls-as-dependencies">URLs as Dependencies</a></li><li><a to="#git-urls-as-dependencies">Git URLs as Dependencies</a></li><li><a to="#github-urls">GitHub URLs</a></li><li><a to="#local-paths">Local Paths</a></li></ul><li><a to="#devdependencies">devDependencies</a></li><li><a to="#peerdependencies">peerDependencies</a></li><li><a to="#peerdependenciesmeta">peerDependenciesMeta</a></li><li><a to="#bundledependencies">bundleDependencies</a></li><li><a to="#optionaldependencies">optionalDependencies</a></li><li><a to="#overrides">overrides</a></li><li><a to="#engines">engines</a></li><li><a to="#os">os</a></li><li><a to="#cpu">cpu</a></li><li><a to="#private">private</a></li><li><a to="#publishconfig">publishConfig</a></li><li><a to="#workspaces">workspaces</a></li><li><a to="#default-values">DEFAULT VALUES</a></li><li><a to="#see-also">SEE ALSO</a></li></ul></div>
</section>
...
settings described in <a to="../using-npm/config.html"><code>config</code></a>.</p>
<h3 id="name">name</h3>
...
<a to="https://www.npmjs.com/">https://www.npmjs.com/</a></li>
</ul>
<p>A name can be optionally prefixed by a scope, e.g. <code>@myorg/mypackage</code>. See
<a to="../using-npm/scope.html"><code>scope</code></a> for more detail.</p>
...
<a to="https://github.com/npm/node-semver">node-semver</a>, which is bundled with
...
<p>You can check <a to="https://spdx.org/licenses/">the full list of SPDX license
IDs</a>.  Ideally you should pick one that is
<a to="https://opensource.org/licenses/alphabetical">OSI</a> approved.</p>
<p>If your package is licensed under multiple common licenses, use an <a to="https://spdx.dev/specifications/">SPDX
...
<a to="../configuring-npm/npm-shrinkwrap-json.html"><code>npm-shrinkwrap.json</code></a> if you wish
...
executable!</p>
<p>Note that you can also set the executable files using <a to="#directoriesbin">directories.bin</a>.</p>
<p>See <a to="../configuring-npm/folders#executables.html">folders</a> for more info on
executables.</p>
<h3 id="man">man</h3>
...
<p>The CommonJS <a to="http://wiki.commonjs.org/wiki/Packages/1.0">Packages</a> spec
details a few ways that you can indicate the structure of your package
using a <code>directories</code> object. If you look at <a to="https://registry.npmjs.org/npm/latest">npm's
...
<p>See <a to="../using-npm/scripts.html"><code>scripts</code></a> to find out more about writing package
scripts.</p>
...
<p>See <a to="https://github.com/npm/node-semver#versions">semver</a> for more details about specifying version ranges.</p>
<ul>
...
<a to="https://github.com/npm/node-semver#versions">semver</a></li>
<li><code>^version</code> "Compatible with version"  See <a to="https://github.com/npm/node-semver#versions">semver</a></li>
...
<li><code>tag</code> A specific version tagged and published as <code>tag</code>  See <a to="../commands/npm-dist-tag.html"><code>npm dist-tag</code></a></li>
<li><code>path/path/path</code> See <a to="#local-paths">Local Paths</a> below</li>
</ul>
...
param.  See <a to="../using-npm/config.html"><code>config</code></a> for more on the topic.</p>
...
<p>Assuming the host complies with <a to="https://semver.org/">semver</a>, only changes
...
default.</p>
<p>See <a to="../using-npm/config.html"><code>config</code></a> to see the list of config options that
can be overridden.</p>
...
up to find each <a to="../using-npm/workspaces.html">workspace</a> that needs to be
...
<p>See <a to="../using-npm/workspaces.html"><code>workspaces</code></a> for more examples.</p>
...
<ul>
<li><a to="https://github.com/npm/node-semver#versions">semver</a></li>
<li><a to="../using-npm/workspaces.html">workspaces</a></li>
<li><a to="../commands/npm-init.html">npm init</a></li>
<li><a to="../commands/npm-version.html">npm version</a></li>
<li><a to="../commands/npm-config.html">npm config</a></li>
<li><a to="../commands/npm-help.html">npm help</a></li>
<li><a to="../commands/npm-install.html">npm install</a></li>
<li><a to="../commands/npm-publish.html">npm publish</a></li>
<li><a to="../commands/npm-uninstall.html">npm uninstall</a></li>
</ul>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/package-json.md">
