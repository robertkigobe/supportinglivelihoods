...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#overview">Overview</a></li><li><a to="#checking-your-version-of-npm-and-nodejs">Checking your version of npm and Node.js</a></li><li><a to="#using-a-node-version-manager-to-install-nodejs-and-npm">Using a Node version manager to install Node.js and npm</a></li><ul><li><a to="#osx-or-linux-node-version-managers">OSX or Linux Node version managers</a></li><li><a to="#windows-node-version-managers">Windows Node version managers</a></li></ul><li><a to="#using-a-node-installer-to-install-nodejs-and-npm">Using a Node installer to install Node.js and npm</a></li><ul><li><a to="#os-x-or-windows-node-installers">OS X or Windows Node installers</a></li><li><a to="#linux-or-other-operating-systems-node-installers">Linux or other operating systems Node installers</a></li><li><a to="#less-common-operating-systems">Less-common operating systems</a></li></ul></ul></div>
</section>
...
<ul>
<li><a to="#checking-your-version-of-npm-and-node-js">Checking your version of npm and
Node.js</a></li>
<li><a to="#using-a-node-version-manager-to-install-node-js-and-npm">Using a Node version manager to install Node.js and
npm</a></li>
<li><a to="#using-a-node-installer-to-install-node-js-and-npm">Using a Node installer to install Node.js and
npm</a></li>
</ul>
...
<ul>
<li><a to="https://github.com/creationix/nvm">nvm</a></li>
<li><a to="https://github.com/tj/n">n</a></li>
</ul>
<h4 id="windows-node-version-managers">Windows Node version managers</h4>
<ul>
<li><a to="https://github.com/marcelklehr/nodist">nodist</a></li>
<li><a to="https://github.com/coreybutler/nvm-windows">nvm-windows</a></li>
</ul>
...
<ul>
<li><a to="https://nodejs.org/en/download/">Node.js installer</a></li>
<li><a to="https://github.com/nodesource/distributions">NodeSource installer</a>. If
...
<a to="https://nodejs.org/en/download/">Node.js download page</a>. Be sure to
...
installers:</p>
<ul>
<li><a to="https://github.com/nodesource/distributions">NodeSource installer</a>
(recommended)</li>
<li>One of the installers on the <a to="https://nodejs.org/en/download/">Node.js download
page</a></li>
</ul>
<p>Or see <a to="https://nodejs.org/en/download/package-manager/">this page</a> to
...
systems, see <a to="https://nodejs.org/en/download/package-manager/">this page</a>.</p>
</div>

<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/install.md">
