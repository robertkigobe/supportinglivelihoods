...
<div id="_table_of_contents"><ul><li><a to="#description">Description</a></li><li><a to="#files">Files</a></li><ul><li><a to="#comments">Comments</a></li><li><a to="#per-project-config-file">Per-project config file</a></li><li><a to="#per-user-config-file">Per-user config file</a></li><li><a to="#global-config-file">Global config file</a></li><li><a to="#built-in-config-file">Built-in config file</a></li></ul><li><a to="#auth-related-configuration">Auth related configuration</a></li><li><a to="#see-also">See also</a></li></ul></div>
</section>
...
<a to="../using-npm/config.html">config</a>.</p>
...
<a to="https://github.com/npm/ini">npm/ini</a>, which specifies this comment syntax.</p>
<p>For example:</p>
...
<footer id="edit">
<a to="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/npmrc.md">
